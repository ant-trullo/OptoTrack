...
class AnalysisSaver:
    ...
    def __init__(self, analysis_folder, fnames, raw_data, software_version, spots_3d_det, spots_trckd, merge_radius,
        ...
        sheet1.write(0, 1, merge_radius)
        sheet1.write(1, 0, "detect threshold")
        sheet1.write(1, 1, detect_thr)
        sheet1.write(2, 0, "min volume thr")
        sheet1.write(2, 1, min_volthr_value)
        sheet1.write(3, 0, "Spots dist Thr")
        sheet1.write(3, 1, dist_thr)
        sheet1.write(4, 0, "Min number of active frames")
        sheet1.write(4, 1, spots_features.min_act_frames)
        sheet1.write(5, 0, "pixels size x-y (µm)")
        sheet1.write(5, 1, raw_data.pix_size_xy)
        sheet1.write(6, 0, "pixels size z (µm)")
        sheet1.write(6, 1, raw_data.pix_size_z)
        sheet1.write(7, 0, "time step (s)")
        sheet1.write(7, 1, raw_data.time_step_value)
        sheet1.write(9, 0, "software version")
        sheet1.write(9, 1, software_version)
        sheet1.write(10, 0, "date")
        sheet1.write(10, 1, datetime.datetime.now().strftime("%d-%b-%Y"))
        sheet1.write(12, 0, "File names")
        for cnt, fname in enumerate(fnames):
            sheet1.write(13 + cnt, 0, fname[fname.rfind('/') + 1:])
